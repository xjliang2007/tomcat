...
public interface SSLSupport {
     ...
     *
     * (a) The size of the encryption key (b) The size of the MAC key (c) The size of the key-exchange key (d) The size
     * of the signature key used by the server
     *
     ...
     *
     * @throws IOException If an error occurs trying to obtain the client requested protocol information from the
     *                     socket
     */
